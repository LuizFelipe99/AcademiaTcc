...
// Insancia a classe controlaPersonal
$controlaPersonal = new ControlaPersonal($conexao, $nomePersonal, $idadePersonal, $tel1Personal,
                                         $tel2Personal,$ruaPersonal, $bairroPersonal,
                                         $cidadePersonal, $sexoPersonal, $formacaoPersonal);
//chama a função de criar personal
$controlaPersonal->createPersonal();
